...
module AliseeksApi
  ...
  class ProductDetailsRequest
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'needStoreInfo')
        self.need_store_info = attributes[:'needStoreInfo']
      else
        self.need_store_info = false
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          need_store_info == o.need_store_info
    end
    ...
    def hash
      [currency, product_id, locale, time_zone, need_store_info].hash
    end
